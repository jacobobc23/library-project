...
public class UserTransactionsWindow extends javax.swing.JFrame {
     ...
     * @param user
     */
    public UserTransactionsWindow(User user) {
        initComponents();
        setLocationRelativeTo(null);
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE); 
        setTitle("Transacciones - " + user.getFullName());
        this.user = user;
    ...
    private void fillTable() {
        ...
        ArrayList<Transaction> transactions = controller.listTransactions(user.getId());
