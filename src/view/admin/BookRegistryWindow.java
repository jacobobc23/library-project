...
public class BookRegistryWindow extends javax.swing.JFrame {
    ...
    private void setCbxGenre() {
        ...
        String[] genresStr = new String[genres.length];

        for (int i = 0; i < genres.length; i++) {
            genresStr[i] = genres[i].name();
        }

        cbxGenre.setModel(new javax.swing.DefaultComboBoxModel<>(genresStr));
        cbxGenre.insertItemAt("Seleccione una opción", 0);
        cbxGenre.setSelectedIndex(0);
    }
